...
class Anomaly:
    def __init__(self, world: carla.World, client: carla.Client, name ,ego_vehicle, is_dynamic, is_character, anomaly_in_waypoint):
        self.world = world
        self.client = client
    ...
    def spawn_anomaly(self):
        ...
        anomaly = spawn_anomaly(self.world, self.client, self.ego_vehicle, self.name, self.is_dynamic, self.is_character, self.anomaly_in_waypoint)
