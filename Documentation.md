...
- `OldStove_Anomaly`: Spawns an old stove in the world, that is placed on the ground, in front of the ego vehicle.
  - `handle_semantic_tag(self)` : Nothing, the semantic tag is `Anomaly` by default.
  - <img src="Images/oldstove.png">
- `ShoppingCart_Anomaly`: Spawns a shopping cart in the world, that is placed on the ground, in front of the ego vehicle.
  - `handle_semantic_tag(self)` : Nothing, the semantic tag is `Anomaly` by default.
  - <img src="Images/shoppingcart.png">
- `Bag_Anomaly`: Spawns a bag in the world, that is placed on the ground, in front of the ego vehicle.
  - `handle_semantic_tag(self)` : Nothing, the semantic tag is `Anomaly` by default.
  - <img src="Images/bag.png">
- `Helmet_Anomaly`: Spawns a helmet in the world, that is placed on the ground, in front of the ego vehicle.
  - `handle_semantic_tag(self)` : Nothing, the semantic tag is `Anomaly` by default.
  - <img src="Images/helmet.png">
- `Hat_Anomaly`: Spawns a hat in the world, that is placed on the ground, in front of the ego vehicle.
  - `handle_semantic_tag(self)` : Nothing, the semantic tag is `Anomaly` by default.
  - <img src="Images/hat.png">
- `Crash_Anomlay`: Spawns two vehicles (if not already present) in front of the ego vehicle, then make them crash.
  - `handle_semantic_tag(self)` : When the vehicles crash, their semantic tag is set from `Vehicle` to `Anomaly`.
  - <img src="Images/crash.png">
- `Bird_Anomaly`: Spawns a bird in the world, that flies in random points when the ego vehicle is close.
  - `handle_semantic_tag(self)` : Nothing, the semantic tag is `Anomaly` by default.
  - <img src="Images/bird.png">
- `TrafficCone_Anomaly`: Spawns a traffic cone in the world, that is placed on the ground, in front of the ego vehicle.
  - `handle_semantic_tag(self)` : Nothing, the semantic tag is `Anomaly` by default.
  - <img src="Images/trafficcone.png">
- `DangerVehicle_Anomaly`: Spawns a vehicle that simulates a dangerous driving behavior. In particular, the vehicle can change lane unsafely,
    ignore traffic lights and stop signs, can ignore other vehicles and has an high speed.
  - `handle_semantic_tag(self)` : If the vehicle crash into another vehicle, the other vehicle's semantic tag is set from `Vehicle` to `Anomaly`.
- `Billboard_Anomaly`: If there's a billboard in front of the ego vehicle, an impulse is applied to it, simulating a fall.
  - `handle_semantic_tag(self)` : Nothing, the semantic tag is `Anomaly` by default.
  - <img src="Images/billboard.png">
- `FallenStreetLight_Anomaly`: If there's a streetlight in front of the ego vehicle, it is projected to the ground, simulating an after fall.
  - `handle_semantic_tag(self)` : Nothing, the semantic tag is `Anomaly` by default.
  - <img src="Images/fallenstreetlight.png">
- `Book_Anomaly`: Spawns a book in the world, that is placed on the ground, in front of the ego vehicle.
  - `handle_semantic_tag(self)` : Nothing, the semantic tag is `Anomaly` by default.
  - <img src="Images/book.png">
- `Stroller_Anomaly`: Spawns a stroller in the world, that is placed on the ground, in front of the ego vehicle.
  - `handle_semantic_tag(self)` : Nothing, the semantic tag is `Anomaly` by default.
  - <img src="Images/stroller.png">
- `FuelCan_Anomaly`: Spawns a fuel can in the world, that is placed on the ground, in front of the ego vehicle.
  - `handle_semantic_tag(self)` : Nothing, the semantic tag is `Anomaly` by default.
  - <img src="Images/fuelcan.png">
- `ConstructionBarrier_Anomaly`: Spawns a construction barrier in the world, that is placed on the ground, in front of the ego vehicle.
  - `handle_semantic_tag(self)` : Nothing, the semantic tag is `Anomaly` by default.
  - <img src="Images/constructionbarrier.png">
- `Suitcase_Anomaly`: Spawns a suitcase in the world, that is placed on the ground, in front of the ego vehicle.
  - `handle_semantic_tag(self)` : Nothing, the semantic tag is `Anomaly` by default.
  - <img src="Images/suitcase.png">
- `CarMirror_Anomaly`: Spawns a car mirror in the world, that is placed on the ground, in front of the ego vehicle.
  - `handle_semantic_tag(self)` : Nothing, the semantic tag is `Anomaly` by default.
  - <img src="Images/carmirror.png">
- `Drone_Anomaly`: Spawns a drone in the world, that flies low in random points.
  - `handle_semantic_tag(self)` : Nothing, the semantic tag is `Anomaly` by default.
  - <img src="Images/drone.png">
- `Umbrella_Anomaly`: Spawns an umbrella in the world, that is placed on the ground, in front of the ego vehicle.
  - `handle_semantic_tag(self)` : Nothing, the semantic tag is `Anomaly` by default.
  - <img src="Images/umbrella.png">
- `Brick_Anomaly`: Spawns a brick in the world, that is placed on the ground, in front of the ego vehicle.
  - `handle_semantic_tag(self)` : Nothing, the semantic tag is `Anomaly` by default.
  - <img src="Images/brick.png">
- `TireScooter_Anomaly`: Spawns a tire scooter in the world, that is placed on the ground, in front of the ego vehicle.
  - `handle_semantic_tag(self)` : Nothing, the semantic tag is `Anomaly` by default.
  - <img src="Images/tirescooter.png">
- `Scooter_Anomaly`: Spawns a scooter in the world, that is placed on the ground, in front of the ego vehicle.
  - `handle_semantic_tag(self)` : Nothing, the semantic tag is `Anomaly` by default.
